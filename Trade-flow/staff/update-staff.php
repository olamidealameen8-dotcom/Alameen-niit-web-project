...
mysqli_query($conn, "UPDATE staff_tab SET  first_name = '$firstName', last_name = '$lastName', email_address = '$emailAddress', phone_number = '$phoneNumber', address = '$address', role_id = '$roleId', status_id = '$statusId', updated_at = NOW() WHERE staff_id = '$staffId'") or die(mysqli_error($conn));
